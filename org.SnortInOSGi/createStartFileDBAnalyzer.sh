...
echo  $T$(ls org.SnortInOSGi.dbanalyzer.DBAreader_1.0.0*.jar)"@6:start,\\">> $CONFIG
echo  $T$(ls org.SnortInOSGi.dbanalyzer.RebuildDB_1.0.0*.jar)"@6:start">> $CONFIG

# create the tar file
cd ${DIR}
cd ..
tar -zcf dbanalyzer.tgz $(basename ${DIR})
